...
type MockPermissionRepository struct {
	...
	GetByRoleIDsFn       func(ctx context.Context, roleIDs []uint) ([]*entity.Permission, error)
}
...
func (m *MockPermissionRepository) GetPermissionsByRoleIDs(ctx context.Context, roleIDs []uint) ([]*entity.Permission, error) {
	if m.GetByRoleIDsFn != nil {
		return m.GetByRoleIDsFn(ctx, roleIDs)
	}
	return nil, nil
}
